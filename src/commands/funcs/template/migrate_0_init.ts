...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "mfa_factors_last_challenged_at_key" ON "auth"."mfa_factors"("last_challenged_at");
...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "saml_providers_entity_id_key" ON "auth"."saml_providers"("entity_id");
